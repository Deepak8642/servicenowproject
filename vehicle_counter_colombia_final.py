...
def run(source,
    ...
    hud       = HUDEngine(direction, system, cam_str, site_name,
                          show_speed=enable_speed, show_trails=True,
                          show_wrong_way=show_wrong_way, show_heatmap=show_heatmap)
    ...
    while True:
        ...
        # Track
        active = tracker.step(dets, lambda cx: lane_mgr.get_lane(cx))
